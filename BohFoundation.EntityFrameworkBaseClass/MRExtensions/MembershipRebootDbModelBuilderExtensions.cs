// From https://github.com/brockallen/BrockAllen.MembershipReboot
...
namespace BohFoundation.EntityFrameworkBaseClass.MRExtensions
{
    public static class MembershipRebootDbModelBuilderExtensions
    {
