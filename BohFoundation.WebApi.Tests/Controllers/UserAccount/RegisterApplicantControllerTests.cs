...
{
    [TestClass]
    public class RegisterApplicantControllerTests
    {
        private RegisterApplicantController _registerApplicantController;
        ...
        public void Initialize()
        {
            ...
            _registerApplicantController = new RegisterApplicantController(_registerApplicant);
        ...
        {
            PostRegisteration();
            A.CallTo(() => _registerApplicant.CreateAccount(Model, MemberTypesEnum.Applicant)).MustHaveHappened();
        }
        ...
        {
            A.CallTo(() => _registerApplicant.CreateAccount(Model, MemberTypesEnum.Applicant)).Throws(new Exception());
            PostRegisteration();
        ...
        {
            A.CallTo(() => _registerApplicant.CreateAccount(Model, MemberTypesEnum.Applicant)).Returns(new SuccessOrFailureDto { Success = false, ExceptionMessage = TestHelpersCommonFields.ExceptionMessage });
            PostRegisteration();
        ...
        {
            A.CallTo(() => _registerApplicant.CreateAccount(Model, MemberTypesEnum.Applicant)).Returns(new SuccessOrFailureDto { Success = true });
            PostRegisteration();
